...
const HAS_DIRECT_GEMINI_KEY = Boolean(import.meta.env.VITE_AI_API_KEY);
const IS_STATIC_HOST =
  typeof window !== 'undefined' &&
  (window.location.hostname.endsWith('github.io') || window.location.protocol === 'file:');
const HAS_SUPABASE_BACKEND = Boolean(import.meta.env.VITE_SUPABASE_URL && import.meta.env.VITE_SUPABASE_ANON_KEY);
